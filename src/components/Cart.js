...
const Cart = () => {
    ...
    return (
        <section className="cart">
            ...
            <div className="cart__menu"><p className="cart__item-name">Course name</p><p className="cart__quantity">Quantity</p><p className="cart__price">Price</p><p className="cart__menu-remove">Remove</p></div>
            <ul className="cart__list">
                {coursesList}
            </ul>
            <p>Total price: EUR</p>
            <div className="cart__btn--section"><NavLink className="cart__btn cart__btn--large" to="/our-courses">Continue shopping</NavLink><button className="cart__btn cart__btn--large">Checkout</button></div>
        </section>
    )
