    ...
    return (
        <nav>
            ...
            <ul className='nav-menu'>
                ...
                <li className='nav-menu-icon'><NavLink to="/cart"><svg id="i-cart" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="30" height="30" fill="none" stroke="currentcolor" strokeLinecap="butt" strokeLinejoin="mitter" strokeWidth="2.5">
